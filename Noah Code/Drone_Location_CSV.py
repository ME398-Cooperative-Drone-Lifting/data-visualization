...
with open('Leader_Position.csv', 'w') as csv_file:
    csv_writer = csv.DictWriter(csv_file, fieldnames = fieldnames)
    csv_writer.writeheader()

with open('Leader_Plot.csv', 'w') as csv_file:
...
while True:
    ...
    with open('Leader_Position.csv', 'a') as csv_file:
        csv_writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
    ...
    with open('Leader_Plot.csv', 'a') as csv_file:
        csv_writer2 = csv.DictWriter(csv_file, fieldnames=fieldnames)
